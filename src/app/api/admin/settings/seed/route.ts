...
const DEFAULT_CONFIGS = [
  ...
  {
    key: "EMAIL_PROVIDER",
    value: process.env.SMTP_HOST ? "smtp" : "resend",
    type: "string",
    label: "E-Mail-Provider",
    description: "Wähle 'smtp' für eigenen Mail-Server oder 'resend' für Resend.com.",
    category: "email",
  },
  {
    key: "SMTP_HOST",
    ...
    type: "string",
    label: "SMTP-Host",
    description: "z.B. smtp.gmail.com, mail.your-clinic.de",
    category: "email",
  },
  {
    key: "SMTP_PORT",
    ...
    type: "number",
    label: "SMTP-Port",
    description: "Standard: 587 (TLS) oder 465 (SSL)",
    category: "email",
  },
  {
    key: "SMTP_USER",
    ...
    description: "E-Mail-Adresse oder SMTP-Login.",
    category: "email",
  },
  {
    key: "SMTP_PASS",
    ...
    type: "string",
    label: "SMTP-Passwort",
    description: "Passwort oder App-spezifisches Passwort.",
    category: "email",
  },
  {
    key: "SMTP_SECURE",
    value: process.env.SMTP_SECURE === "true" ? "true" : "false",
    type: "boolean",
    label: "SSL/TLS erzwingen",
    description: "Wenn aktiv, wird eine verschlüsselte Verbindung erzwungen (Port 465 empfohlen).",
    category: "email",
  },
  {
    key: "EMAIL_ENABLED",
    value: process.env.RESEND_API_KEY || process.env.SMTP_HOST ? "true" : "false",
    type: "boolean",
